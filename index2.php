...
<head>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD2SLN_jrwM5MCqTLAIcJcLkuORj5dLiPw&callback=initMap&libraries=marker,places&v=beta"></script>
    <style>
        span {
...
<body>
    ...
    <script>
        let draw_map = (latitude, altitude) => {
            ...
            var Options = {
                mapId: 'AIzaSyD2SLN_jrwM5MCqTLAIcJcLkuORj5dLiPw',
                zoom: 15,      //地図の縮尺値
            ...
            setTimeout(() =>{
                ...
                // class をセット
                markerElement.innerHTML = "<span>現在地</span>";
                          ...
                          for (var i in results) {
                              if (results[0].geometry) {
                                  ...
                                  // マーカー用カスタムHTML  
                                    let markerElement = document.createElement("div");
                                    // class をセット
                                    markerElement.innerHTML = "<span><a href='" + event_info_packet.officialsite + "'>" + event_info_packet.title + "</a></span>";
                                    const markerView = new google.maps.marker.AdvancedMarkerView({
                                        map,
                                        position: latlng,
                                        content: markerElement, // カスタムHTMLマーカーをセット
